...
public class Project {
    ...
    public Project(ProjectManagerDTO projectManagerDTO, TeamMembers member, Status status) {

        this.name = projectManagerDTO.projectName;
        this.description = projectManagerDTO.description;
